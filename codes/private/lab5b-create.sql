...
-- Create Users
CREATE USER userAppAdmin IDENTIFIED BY userAppAdminPassword ACCOUNT UNLOCK
...
GRANT applicationAdmin TO userAppAdmin;
...
CONNECT userAppAdmin/userAppAdminPassword;
